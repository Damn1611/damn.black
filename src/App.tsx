...
function App() {
    ...
    useEffect(() => {
        const calculateTimeLeft = () => {
            const difference = +new Date("Jun 22, 2025 00:00:00") - +new Date();
    ...
    return (
        <div className={`App ${isTypingFinished ? "App-loaded" : ""}`}>
            ...
            <div className="container" onLoad={handleQuote}>
                <h1
                    className={`big-text ${
                        isTypingFinished ? "big-text-done" : ""
                    }`}
                >
                    <Typewriter
                        options={{
                        ...
                        onInit={(typewriter) => {
                            typewriter
                                .typeString(
                                    '<span class="text-primary">Damn.</span>black'
                                )
                                .callFunction(() => {
